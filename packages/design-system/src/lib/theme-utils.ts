...
export function createComponentVariants(baseClasses: string = "") {
  return {
    ...
    size: {
      sm: cn(
        SIZE_MAPPINGS.sm.padding,
        SIZE_MAPPINGS.sm.text,
        SIZE_MAPPINGS.sm.height
      ),
      md: cn(
        SIZE_MAPPINGS.md.padding,
        SIZE_MAPPINGS.md.text,
        SIZE_MAPPINGS.md.height
      ),
      lg: cn(
        SIZE_MAPPINGS.lg.padding,
        SIZE_MAPPINGS.lg.text,
        SIZE_MAPPINGS.lg.height
      ),
    },
  };
}
